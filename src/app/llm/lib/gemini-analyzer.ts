...
const SYSTEM_PROMPT = `Eres un Agente experto en agronomía y fitopatología. Analiza el video de cultivo de papa y detecta rastros de Tizón temprano (Alternaria solani) o Tizón tardío (Phytophthora infestans).
...
export async function analyzeVideoWithGemini(
  ...
  const result = await model.generateContent([
    ...
    {
      text: "Analiza el video de cultivo de papa y devuelve el JSON con el análisis de enfermedades detectadas.",
    },
  ]);
